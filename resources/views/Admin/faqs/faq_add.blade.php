...
<div class="nk-block nk-block-lg">
    ...
    <div class="card card-bordered">
        <div class="card-inner">
            <div class="nk-block">
                <form action="{{ url('admin-dashboard/faq-add-procc') ?? '' }}" class="form-validate" novalidate="novalidate" method="post">
                @csrf
                ...
                @else
                    <input type="hidden" name="handle" value="{{ Cookie::get('language_code', config('app.locale')) }}" />
                @endif
                    <div class="row g-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <input type="text" class="form-control" name="question" id="question" value="{{isset($faqTranslation) ? $faqTranslation->question : $faq->question }}">
                                    </div>
                                </div>
                                @error('question')
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="form-group">
                            <button class="addCategory btn btn-primary  text-center"><em class="icon ni ni-plus"></em><span>{{isset($faq) ? 'Update Faq' : 'Add Faq'}}</span></button>
                        </div>
                    </div>
                </form>
            </div>
